    ...
    <div className="h-screen w-screen overflow-hidden relative">
      ...
      <div className="relative flex items-center justify-center min-h-screen p-4">
        ...
        <div className="bg-white/70 rounded-3xl p-5 w-[650px] min-h-[690px] flex flex-col items-center shadow-2xl border border-white/30 gap-[70px]">
          ...
          {/* Get Started Button */}
          <button className="bg-blue-950 text-white h-[50px] w-[70%] rounded-lg text-xl font-semibold hover:bg-blue-900 cursor-pointer transition-colors shadow-md shadow-gray-600">
            Let's Get Started
          </button>
        </div>
      </div>
