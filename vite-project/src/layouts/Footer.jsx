    ...
    return (
        ...
        <div className="container px-6 mx-auto">
            ...
            <div className="flex space-x-4">
                <a href="https://linkedin.com" className="p-2 transition-colors bg-gray-800 rounded-full hover:bg-teal-400">
                <Linkedin size={20} />
                </a>
                <a href="https://facebook.com" className="p-2 transition-colors bg-gray-800 rounded-full hover:bg-teal-400">
                <Facebook size={20} />
                </a>
                <a href="https://instagram.com" className="p-2 transition-colors bg-gray-800 rounded-full hover:bg-teal-400">
                <Instagram size={20} />
                </a>
            </div>
            </div>
