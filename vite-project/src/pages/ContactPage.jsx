    ...
    return (
        ...
        <section className="container max-w-6xl mx-auto">
            ...
            <div className="w-full md:w-1/2 md:pr-8">
                ...
                At LunaRest, we are dedicated to transform sleep health through innovation 
                ...
                <button className="px-6 py-3 text-white transition duration-300 transform rounded-full shadow-lg bg-h2 hover:bg-purple-700 hover:shadow-xl hover:-translate-y-1">
                    Learn more about us
                </button>
                </div>
            </div>
